...
*/
const followingStyle = StyleSheet.create({
  oneFollowingView: {
    flexDirection: 'row',
    height: 75,
...
const FollowingView = ({ navigation }) => {
  ...
  const renderItem = ({ item }) => (
    <View style={followingStyle.oneFollowingView}>
      <Image source={{ uri: item.avatarUrl }} style={followingStyle.avatar} />
